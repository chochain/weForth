...
function initPhysics() {
	...
	// Helper functions
	Jolt.Vec3.prototype.ToString  = ()=> `(${this.GetX()}, ${this.GetY()}, ${this.GetZ()})`;
	Jolt.RVec3.prototype.ToString = ()=> `(${this.GetX()}, ${this.GetY()}, ${this.GetZ()})`;
	Jolt.Quat.prototype.ToString  = ()=> `(${this.GetX()}, ${this.GetY()}, ${this.GetZ()}, ${this.GetW()})`
	Jolt.AABox.prototype.ToString = ()=> `[${this.mMax.ToString()}, ${this.mMin.ToString()}]`;
	Jolt.Vec3.prototype.Clone     = ()=> new Jolt.Vec3(this.GetX(), this.GetY(), this.GetZ());
	Jolt.RVec3.prototype.Clone    = ()=> new Jolt.RVec3(this.GetX(), this.GetY(), this.GetZ());
	Jolt.Quat.prototype.Clone     = ()=> new Jolt.Quat(this.GetX(), this.GetY(), this.GetZ(), this.GetW());
}
...
function renderExample() {
    ...
    for (let k in dynamicObjects) {
		let objThree = dynamicObjects[k];
...
function addToScene(body, color) {
	...
	dynamicObjects[id.GetIndex()] = threeObject;
}
...
function removeFromScene(threeObject) {
	...
	delete dynamicObjects[id.GetIndex()];
}
