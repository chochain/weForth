///
/// @file
/// @brief weForth - System dependent functions
///
///====================================================================
///
...
int  vm_tos()        { return TOS;        }
DU   *vm_ss()        { return &SS[0];     }
int  vm_base()       { return *vm.base;   }
int  vm_dflt()       { return *vm.dflt;   }
...
int  forth_include(const char *fn) {              ///> include with Javascript
    ...
    istream ism(&strbuf);                         ///< attach string to stream
    outer(ism);
